...
tags: ["query:vlm"]
score: 7.0
evidence: 用于实例分割的视觉几何定位Transformer
...
result: 在ScanNetv2和ScanNet200数据集上实现了最先进的性能，优于现有的联合模型及基于RGB-D的方法。
conclusion: 该研究成功将3D重建与实例分割整合进统一的前馈Transformer中，为多视图3D场景理解提供了高效且鲁棒的解决方案。
---
