...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-07-29 21:48:57 UTC<br>状态：成功</p>
</section>
...
<p>今日精读7篇速读1篇，聚焦无搜索世界模型与视觉语言导航的双脑表征。最值得关注的是满分论文《INTACT》提出的同构意图到动作学习，以及《Dual-Brain》的最小充分表征方法。建议优先精读这两篇，探索如何将意图与感知解耦以提升模型泛化能力。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="INTACT: Isomorphic Intent-to-Action Learning for Search-Free World Models">INTACT: Isomorphic Intent-to-Action Learning for Search-Free World Models</span></li><li><span class="dpr-home-dashboard-paper-title" title="Towards Dual-Brain Minimal Sufficient Representation for Vision-Language Navigation">Towards Dual-Brain Minimal Sufficient Representation for Vision-Language Navigation</span></li><li><span class="dpr-home-dashboard-paper-title" title="VisualPatchWorld: Code World Models as Latent Structured Representations for Planning">VisualPatchWorld: Code World Models as Latent Structured Representations for Planning</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">world-model <strong>5</strong></span><span class="dpr-home-dashboard-tag">vt <strong>2</strong></span></div>
</section>
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Unified Prediction and Planning via Conflict-Aware Disjoint Parameter Training">Unified Prediction and Planning via Conflict-Aware Disjoint Parameter Training</span></li></ul>
  </div>
